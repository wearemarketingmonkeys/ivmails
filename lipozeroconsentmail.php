...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = "LipoZero Consent Form Submission | " . $_POST['fullName'];

    // Build email body
    $body = "<html><body>";
    $body .= "<h2>LipoZero Consent Submission</h2>";
    ...
    $body .= "<hr><p><strong>Submitted via LipoZero Consent Form on IVHUB</strong></p>";
    $body .= "</body></html>";
